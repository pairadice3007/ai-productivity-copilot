...
def _build_prompt(
    ...
    return (
        ...
        f"{commitment_line}\n\n"
        "Based on the screenshot and the context above, respond ONLY in this exact format "
        "(no extra text before or after):\n"
        "DOING: <one sentence describing what I'm currently doing>\n"
        "CATEGORY: <productive|drift|break|unknown>\n"
        "CONFIDENCE: <0.0 to 1.0>\n"
        "TASK: <exact task name from list, or 'none'>\n"
        "NUDGE: <1-2 sentence coaching message>\n"
        "FOCUS: <what I should do next and why>"
    )
